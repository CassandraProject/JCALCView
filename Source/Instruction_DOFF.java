...
class Instruction_DOFF implements Instruction_Interface
{
    Instruction_DOFF() {
    ...
    public void Run (Steps_Table_Model steps, Stack_Table_Model stack, Machine reg) {
        ...
        try {
            ...
            if (s.Number_1())		n = java.lang.Math.abs(s.Get_Value1());
            else if (s.Register_1()) 	n = java.lang.Math.abs(reg.Index_To_Memory(s.Get_Register1()).Get_Value());
            else 			n = 1.0F;
