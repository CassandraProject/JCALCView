...
public class Icon_Download implements Icon, SwingConstants
{
    ...
    {    
        ...
        px[2] = x + w - BORDER;		py[2] = y + BORDER + BAR_THICKNESS;
        px[3] = x + BORDER;		py[3] = y + BORDER + BAR_THICKNESS;
        
        Polygon p1 = new Polygon(px, py, 4);
        g.drawPolygon(p1);
        g.fillPolygon(p1);
        
        px[0] = x + BORDER;		py[0] = y + BORDER + BAR_THICKNESS + GAP;	
        px[1] = x + w/2;		py[1] = y + h - BORDER;				
        px[2] = x + w - BORDER;		py[2] = y + BORDER + BAR_THICKNESS + GAP;	
