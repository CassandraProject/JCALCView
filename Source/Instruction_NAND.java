...
class Instruction_NAND implements Instruction_Interface
{
    Instruction_NAND() {
    ...
    public void Run (Steps_Table_Model steps, Stack_Table_Model stack, Machine reg) {
        ...
        try {
            if (s.Empty_1()) {
                boolean result = (int) stack.Top(0) != 0;
                ...
                boolean acc = (int) stack.Top(0) != 0;
                boolean r = (int) reg.Index_To_Memory(s.Get_Register1()).Get_Value() != 0;
                ...
                boolean r1 = (int) reg.Index_To_Memory(s.Get_Register1()).Get_Value() != 0;
                boolean r2 = (int) reg.Index_To_Memory(s.Get_Register2()).Get_Value() != 0;
