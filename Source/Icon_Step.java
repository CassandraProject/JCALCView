...
public class Icon_Step implements Icon, SwingConstants
{
    ...
    {    
        ...
        px[1] = x + BORDER + BAR_THICKNESS;	py[1] = y + BORDER;
        px[2] = x + BORDER + BAR_THICKNESS;	py[2] = y + h - BORDER;
        ...
        px[0] = x + BORDER + BAR_THICKNESS + GAP;	py[0] = y + BORDER;
        px[1] = x+w - BORDER;				py[1] = y + h/2;
        px[2] = x + BORDER + BAR_THICKNESS + GAP;	py[2] = y + h - BORDER;
